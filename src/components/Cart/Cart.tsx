...
const Cart = () => {
  ...
  const cartItems = useAppSelector((state) => state.cart.items); // Get cart items from Redux store
  ...
  // Dispatch Redux actions for quantity and removal
          ...
          <Card className="border-0 shadow-sm">
            <Card.Body>
              {cartItems.length === 0 ? (
                ...
                // Map through cart items from Redux store
                cartItems.map((item) => (
