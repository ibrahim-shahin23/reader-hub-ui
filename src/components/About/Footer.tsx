...
const Footer: React.FC = () => (
  <>
    <style>{`
      ...
      .about-container .footer-heading {
        font-size: 1.25rem;
        font-weight: 700;
        color: white;
        margin-bottom: 1rem;
      ...
      .about-container .social-link:hover {
        color: white;
      }
    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-grid">
          <div className="footer-section">
            ...
            <p className="footer-text">
              Connecting publishers, authors, and readers in a seamless
              virtual environment.
            </p>
          </div>
          <div className="footer-section">
        ...
        {/* <div className="footer-copyright">
          <p>© {new Date().getFullYear()} Reader Hub. All rights reserved.</p>
        </div> */}
      </div>
    </footer>
  </>
