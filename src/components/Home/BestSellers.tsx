...
const BestSellers: React.FC = () => {
  ...
  const [alertVariant, setAlertVariant] = useState<'success' | 'info'>(
    'success'
  );
  ...
  const bestSellers: Book[] = [
    {
      ...
      publisher: 'Avery',
      coverImage:
        'https://www.shoroukbookstores.com/images/Books/original/9781847941831.jpg?random=638835435084013853',
      description:
    ...
    },
    {
      ...
      coverImage:
        'https://diwanegypt.com/wp-content/uploads/2022/02/9780857197689.jpg',
      description:
        'Doing well with money isn’t necessarily about what you know. It’s about how you behave. And behavior is hard to teach, even to really smart people. This book helps you think about your approach to money.',
      price: 23.99,
      inStock: true,
    ...
    },
    {
      ...
      coverImage:
        'https://diwanegypt.com/wp-content/uploads/2024/08/9781529146707.jpg',
      description:
    ...
    },
    {
      ...
      description:
        'Amoral, cunning, ruthless, and instructive, this New York Times bestseller is the definitive manual for anyone interested in gaining, or defending against, ultimate control.',
      price: 25.5,
      inStock: true,
  ...
  const toggleFavorite = (book: Book) => {
    if (isFavorite(book.id)) {
      ...
      showTemporaryAlert(
        `${book.title} has been removed from favorites!`,
        'info'
      );
    } else {
              ...
              <Card.Img
                ...
                onError={(e) => {
                  (e.target as HTMLImageElement).src =
                    'https://via.placeholder.com/250x250?text=Book+Cover';
                }}
              />
                ...
                <div className="mt-auto">
                  <div className="d-flex justify-content-between align-items-center">
                    ...
                    <div className="d-flex gap-2">
                      ...
                      <Button
                        variant={
                          isFavorite(book.id) ? 'danger' : 'outline-danger'
                        }
                        size="sm"
                        className="rounded-circle p-2 d-flex align-items-center justify-content-center"
                        style={{ width: '34px', height: '34px' }}
            ...
            <Row>
              ...
              <Col md={8}>
                ...
                <div className="d-flex gap-3">
                  ...
                  <Button
                    variant={
                      isFavorite(selectedBook.id) ? 'danger' : 'outline-danger'
                    }
                    size="lg"
